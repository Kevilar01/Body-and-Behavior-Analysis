      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="font-montserrat text-lg text-neutral-taupe">
            Everything you need to know about our Body and Behavior Analysis Mapping Method
          </p>
        </div>
        ...
        <Accordion type="single" collapsible className="space-y-4">
          <AccordionItem value="item-1" className="bg-white/80 rounded-lg border border-accent/10 px-6">
            <AccordionTrigger className="font-montserrat font-semibold text-primary hover:text-accent">
               What is Body and Behavior Analysis Mapping?
            </AccordionTrigger>
          ...
          <AccordionItem value="item-9" className="bg-white/80 rounded-lg border border-accent/10 px-6">
            ...
            <AccordionContent className="font-montserrat text-neutral-taupe leading-relaxed">
              I offer both — single Body and Behavior Analysis Mapping sessions to map your patterns, and an 8-session program that includes the powerful Master Key Tool alongside the Body and Behavior Analysis Mapping Method for deeper integration and transformation.
            </AccordionContent>
          </AccordionItem>

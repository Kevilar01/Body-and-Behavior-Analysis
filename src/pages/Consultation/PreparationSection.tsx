      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="text-2xl sm:text-3xl font-medium text-primary mb-8">
            How to Prepare for Your Body and Behavior Analysis Session
          </h2>
          <p className="text-lg text-neutral-taupe mb-8">
            ✨ To get the most accurate and transformative insights during your Body and Behavior Analysis, please follow these simple steps:
          </p>
        ...
        <div className="mt-12 bg-gradient-to-r from-accent/5 to-primary/5 border-l-4 border-accent rounded-r-lg p-6">
          ...
          <div className="bg-white/50 rounded-lg p-4 border-l-4 border-primary">
            <p className="text-neutral-taupe italic">
              These preparations ensure a precise, powerful reading of your body's emotional map — giving you the most from your Body and Behavior Analysis.
            </p>
          </div>
        </div>
      </div>

  ...
  const mentoringPackages = [
    {
      ...
      title: 'Body and Behavior Analysis Mapping Session',
      sessions: '1 session',
    ...
    },
    {
      ...
      sessions: '8 sessions',
      description: 'Deep-dive mentorship using the Body and Behavior Analysis Mapping Method, emotional mastery & life design.',
      price: '$2,497',
      featured: true
    },
    {
          ...
          <div className="text-center animate-fade-in">
            ...
            <div className="prose prose-lg text-neutral-taupe leading-relaxed space-y-6 max-w-3xl mx-auto">
              ...
              <p>
                ...
                Through Body and Behavior Analysis, body intelligence, and emotional integration,<br />

...
const MasterKey = () => {
  const sessions = [
    {
      session: 1,
      title: "Body and Behavior Analysis Mapping",
      description: "We begin with a full Body and Behavior Analysis Mapping Method session, observing your body and patterns to understand the emotional roots behind your difficulties, challenges, and concerns.",
      image: "https://images.unsplash.com/photo-1649972904349-6e44c42644a7?w=400&h=300&fit=crop"
    },
    {
      session: 2,
      title: "Debrief: Part One",
      description: "We review the first part of your Body and Behavior Analysis in detail, helping you integrate insights and start connecting how your patterns relate to your current struggles.",
      image: "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=400&h=300&fit=crop"
    },
    {
      session: 3,
      title: "Debrief: Part Two & Goal Setting",
      description: "We complete your Body and Behavior Analysis debrief, exploring deeper layers of your patterns. Together, we set meaningful goals and create a clear plan to move forward based on what you've discovered.",
  ...
  return (
    <div className="font-montserrat">
      {/* Hero Section */}
      <section className="text-white py-20" style={{ backgroundColor: '#4A6B6B' }}>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center animate-fade-in">
              <div className="prose prose-lg text-neutral-taupe leading-relaxed space-y-6">
                <p className="text-xl font-medium text-accent">
                  The Master Key is a therapeutic application of Body and Behavior Analysis that works directly with a specific emotional pain — a real-life situation that is affecting your emotional balance.
                </p>
